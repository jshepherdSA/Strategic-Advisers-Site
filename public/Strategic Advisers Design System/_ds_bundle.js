/* @ds-bundle: {"format":4,"namespace":"StrategicAdvisersDesignSystem_281076","components":[{"name":"IndustryCard","sourcePath":"components/cards/IndustryCard.jsx"},{"name":"ServiceCard","sourcePath":"components/cards/ServiceCard.jsx"},{"name":"TestimonialCard","sourcePath":"components/cards/TestimonialCard.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Eyebrow","sourcePath":"components/core/Eyebrow.jsx"},{"name":"Stat","sourcePath":"components/core/Stat.jsx"},{"name":"Field","sourcePath":"components/forms/Field.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"CTASection","sourcePath":"components/sections/CTASection.jsx"},{"name":"SectionHeader","sourcePath":"components/sections/SectionHeader.jsx"}],"sourceHashes":{"components/cards/IndustryCard.jsx":"0564e488a27c","components/cards/ServiceCard.jsx":"f8138b834113","components/cards/TestimonialCard.jsx":"47f06d42896d","components/core/Badge.jsx":"009a1f3bfd1e","components/core/Button.jsx":"f5e0ade56077","components/core/Eyebrow.jsx":"2e1aece3b14b","components/core/Stat.jsx":"e16392abb791","components/forms/Field.jsx":"c715fe655c69","components/forms/Input.jsx":"2ee45f4e29e5","components/sections/CTASection.jsx":"785710c6d8d2","components/sections/SectionHeader.jsx":"a5ea5995dca5","ui_kits/website/App.jsx":"d3535c109cf0","ui_kits/website/ContactScreen.jsx":"32fcc6d090ea","ui_kits/website/Footer.jsx":"0b64f11c79af","ui_kits/website/HomeScreen.jsx":"561f1117dcd3","ui_kits/website/IndustriesScreen.jsx":"1969822e4f56","ui_kits/website/NavBar.jsx":"750bd64aaafa","ui_kits/website/ServicesScreen.jsx":"fdd803dfc06d","ui_kits/website/data.jsx":"33ab2bb78b7f","ui_kits/website/icons.jsx":"f8dd2d645656"},"inlinedExternals":[],"unexposedExports":[]} */
...
function IndustryCard({
  ...
  return /*#__PURE__*/React.createElement("a", _extends({
    ...
    style: {
      ...
      boxShadow: hover ? 'var(--shadow-block)' : 'var(--shadow-sm)',
    ...
    style: {
      ...
      borderColor: hover ? 'var(--red-700)' : 'rgba(255,255,255,0.5)',
...
function ServiceCard({
  ...
  return /*#__PURE__*/React.createElement("a", _extends({
    ...
    style: {
      ...
      width: '54px',
      height: '54px',
      background: hover ? 'var(--red-700)' : 'var(--navy-900)',
      color: '#fff',
...
function Button({
  ...
  const hoverMap = {
    primary: (e, on) => {
      ...
      e.currentTarget.style.borderColor = on ? 'var(--red-800)' : 'var(--red-700)';
    },
    secondary: (e, on) => {
      e.currentTarget.style.background = on ? 'var(--navy-900)' : 'var(--navy-700)';
      e.currentTarget.style.borderColor = on ? 'var(--navy-900)' : 'var(--navy-700)';
    },
    outline: (e, on) => {
      e.currentTarget.style.background = on ? 'var(--navy-900)' : 'transparent';
      e.currentTarget.style.color = on ? '#fff' : 'var(--navy-800)';
    },
    ghost: (e, on) => {
...
function HomeScreen({
  ...
  }, "3.4M"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '13px',
      lineHeight: 1.35,
      color: 'var(--navy-800)'
    }
  }, "earned impressions on a single announcement.")), /*#__PURE__*/React.createElement("div", {
    style: {
      gridColumn: '2',
      gridRow: '3',
      background: 'var(--navy-900)'
