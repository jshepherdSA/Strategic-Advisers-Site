          ...
          <div style={{ maxWidth: '320px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '22px' }}>
              {['linkedin', 'twitter', 'facebook', 'instagram'].map((s) => (
                <a key={s} href="#" onClick={(e) => e.preventDefault()} style={{ width: '38px', height: '38px', border: '1px solid rgba(255,255,255,0.22)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'var(--navy-100)', transition: 'all var(--dur-fast) var(--ease-standard)' }}
